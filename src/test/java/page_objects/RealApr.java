...
public class RealApr {
    ...
    private final By ActualAprRate = By.xpath("//*[@id='analysisDiv']/table/tbody/tr/td/strong[text()='Actual APR:']/../../td[2]/strong[text()='3.130%']");
    ...
    public RealApr typeHomePrice(String value) {
        ...
        ActOn.element(driver, HomePriceInputField).setValues(value);
        return this;
    }
    ...
    public RealApr typeDownPayment(String value) {
        ...
        ActOn.element(driver, DownPaymentInputField).setValues(value);
        return this;
    }

    public RealApr typeInterestRate(String value) {
        LOGGER.debug("Typing the interest rate: " + value);
        ActOn.element(driver, InterestRateInputField).setValues(value);
        return this;
    }
